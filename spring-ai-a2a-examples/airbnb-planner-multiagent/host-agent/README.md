...
The core pattern used in `RemoteAgentConnections` for each agent call:
...
private String callAgent(String agentUrl, String query) throws Exception {
    ...
    AgentCard agentCard = AgentCard.builder()
        ...
        .additionalInterfaces(List.of(new AgentInterface("JSONRPC", agentUrl)))
        .build();
...
- **`HostAgentApplication.java`** - Spring Boot application
- **`RemoteAgentConnections.java`** - Core service demonstrating direct SDK pattern
