...
/**
 * Travel planning orchestrator using remote A2A agents.
 *
...
public class HostAgentApplication {
	...
	private static final Logger logger = LoggerFactory.getLogger(HostAgentApplication.class);
	...
	/**
	 * Interactive console for travel planning queries.
	 */
	@Bean
